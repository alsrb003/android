                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.action_game: {
                        ...
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.main_content, game_fragment).commitAllowingStateLoss();
                        return true;
                    }
                    case R.id.action_community: {
                        Log.v("dm","커뮤니티 탭 클릭");
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.main_content, community_fragment).commitAllowingStateLoss();
                        return true;
                    }
                    case R.id.action_map: {
                        Log.v("dm","맵 탭 클릭");
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.main_content, map_fragment).commitAllowingStateLoss();
                        return true;
                    }
